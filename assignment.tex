...
\begin{document}
\title{Case Study: Contagions in the real world}
...
\paragraph{
Humans and computers alike are suspetible to diseases which can be detrimental too them.
Social networks and computer networks are similar too, they are both examples of complex networks. 
This provides an opportunity in which we can attempt to understand how diseases spread in both humans and computers.}
